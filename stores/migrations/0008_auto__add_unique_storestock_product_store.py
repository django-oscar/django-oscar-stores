...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'StoreStock', fields ['product', 'store']
        db.create_unique('stores_storestock', ['product_id', 'store_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'StoreStock', fields ['product', 'store']
        db.delete_unique('stores_storestock', ['product_id', 'store_id'])
