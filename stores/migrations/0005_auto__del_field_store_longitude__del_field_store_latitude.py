...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Store.longitude'
        db.delete_column('stores_store', 'longitude')

        # Deleting field 'Store.latitude'
        db.delete_column('stores_store', 'latitude')


    def backwards(self, orm):
        
        # Adding field 'Store.longitude'
        db.add_column('stores_store', 'longitude', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'Store.latitude'
        db.add_column('stores_store', 'latitude', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)
