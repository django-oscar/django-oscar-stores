...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Store.phone'
        db.alter_column('stores_store', 'phone', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):

        # Changing field 'Store.phone'
        db.alter_column('stores_store', 'phone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
