...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('stores_storeaddress', 'postcode', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):

        # Changing field 'StoreAddress.postcode'
        db.alter_column('stores_storeaddress', 'postcode', self.gf('django.db.models.fields.CharField')(default='', max_length=64))
