...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Store', fields ['slug']
        db.delete_unique('stores_store', ['slug'])


    def backwards(self, orm):
        # Adding unique constraint on 'Store', fields ['slug']
        db.create_unique('stores_store', ['slug'])
