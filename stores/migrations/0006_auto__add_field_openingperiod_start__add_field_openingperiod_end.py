...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OpeningPeriod.start'
        db.add_column('stores_openingperiod', 'start',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'OpeningPeriod.end'
        db.add_column('stores_openingperiod', 'end',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OpeningPeriod.start'
        db.delete_column('stores_openingperiod', 'start')

        # Deleting field 'OpeningPeriod.end'
        db.delete_column('stores_openingperiod', 'end')
